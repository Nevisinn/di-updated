...
Можно воспользоваться [Pure.DI](https://www.nuget.org/packages/Pure.DI/) или довольно распространенным di
контейнером [Autofac](https://www.nuget.org/packages/Autofac/). В выборе di контейнера может помочь
